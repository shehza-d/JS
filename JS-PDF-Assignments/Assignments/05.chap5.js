function question1() {
	...
	document.write("The Subtraction of " + num1 + " and " + num2 + " is " + minus + "<br>");
	...
	document.write("The Modulus of " + num1 + " and " + num2 + " is " + modulus + "<br><br><br>");
}
function question3() {
	let randomVariable = parseInt(prompt("Initialize the variable:"));
	let s7 = randomVariable + 7;

	document.write("Value after variable declaration is: " + randomVariable + "<br>");
	...
	document.write("Remainder after dividing the variable’s value by 3 : " + e3 + "<br>")
}
//chapter 5 question 4
function question4() {
	let ticket = prompt("How may Movie tickets you want to buy :");
	let ticktetPrice = ticket * 600;
	document.write("<br><br><br>The total amount to buy " + ticket + " tickets to a movie is " + ticktetPrice + "PKR.")
}

function question6() { 
let celsiusTemp = prompt(`Please enter Temperature in Celsius`);
		let f = (celsiusTemp * 9 / 5) +32; let nf = f.toFixed(2);
		let fahrenTemp = prompt(`Please enter Temperature in Fahrenheit`);
		let c = (fahrenTemp -32) * 5 / 9; let nc = c.toFixed(2);
		document.write(`${celsiusTemp}°Celsius is ${f}°Fahrenheit<br>`);
		document.write(`${fahrenTemp}°Fahrenheit is ${nc}°Celsius<br><br><a href="./chapter5-6.html"><button>Back</button></a>`);
	}

function question1() {
  ...
  if (city === "karachi") {
    document.querySelector("#city_greeting").innerHTML =
      "Welcome to the City of lights! Karachi";
  } else if (city == "lahore") {
    document.querySelector("#city_greeting").innerHTML =
      "Welcome to the City of Gardens! Lahore";
  } else if (city == "islamabad") {
    document.querySelector("#city_greeting").innerHTML =
      "Welcome to the City of Islam and Peace! Islamabad";
  } else if (city == "quetta") {
    document.querySelector("#city_greeting").innerHTML =
      "Welcome to the City of Fruits! Quetta";
  } else if (city == "peshawar") {
    document.querySelector("#city_greeting").innerHTML =
      "Welcome to the City of Flowers! Peshawar";
  } else {
...
function question6() {
  ...
  document.querySelector(
    "#total_markss"
  ).innerHTML = `Your total marks are ${total_marks}`;
  document.querySelector(
    "#obtain_markss"
  ).innerHTML = `Your obtained marks are ${obtain_marks}`;

  if (total_marks < obtain_marks) {
    alert("obtain marks can't be greater than total marks");
    return;
  } else {
    let oPercentage = (obtain_marks / total_marks) * 100;
    document.querySelector(
      "#percentage"
    ).innerHTML = `Your percentage is ${oPercentage}%`;
...
let question7 = () => {
  ...
  if (random_number === guess_number0) {
    document.querySelector(
      "#guess_number_result"
    ).innerText = `Bingo! You guessed the correct number`;
  } else {
    document.querySelector(
      "#guess_number_result"
    ).innerText = `Sorry! You guessed the wrong number`;
  }
  if (guess_number0 % 3 === 0) {
    document.querySelector(
      "#eight"
    ).innerText = `${guess_number0} is divisible by 3`;
  } else {
    document.querySelector(
      "#eight"
    ).innerText = `${guess_number0} is not divisible by 3`;
  }
  if (guess_number0 % 2 == 0) {
    //checking odd or even number
    document.querySelector(
      "#nine-odd-even"
    ).innerText = `${guess_number0} is Even number`;
  } else {
    document.querySelector(
      "#nine-odd-even"
    ).innerText = `${guess_number0} is Odd number`;
  }
};
//question 10
const question10 = () => {

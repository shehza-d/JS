...
<body>
    ...
    <br><br><BR></BR>
    <form onsubmit="matrix_multiply(); return false" class="form2">
    ...
    <script>
        ...
        function matrix_multiply() {
            ...
            let result_matrix = multiply(arr1, arr2);
            console.log(result_matrix);
            for (let i = 0; i < row; i++) {
                for (let j = 0; j < column; j++) {
                    result_div.innerHTML += `<input type="number" disabled required  id="Result_values_${i}${j}" value="${result_matrix[i][j]}" style="width: 30px;">`;
                }
